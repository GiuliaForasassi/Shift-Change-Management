...
%PERSONALE INSUFFICIENTE PER COPERTURA OTTIMALE
...
Supponiamo di voler pianificare l'orario di 20 infermieri per un periodo di 1 settimana, dove i turni che ogni infermiere può svolgere sono tre: mattina, pomeriggi e notte.
In Tabella \ref{tab:TabellaOutput} riporta l'output del modello creato.
...
\textit{Erma} &  & {\color[HTML]{009901} \textbf{P}} & {\color[HTML]{009901} \textbf{P}} & {\color[HTML]{CB0000} \textbf{M}} & {\color[HTML]{CB0000} M} & {\color[HTML]{3531FF} \textbf{N}} &  \\ \hline
